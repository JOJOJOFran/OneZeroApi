...
namespace OneZero.Core
{
    public abstract class BaseService: IMapService, IPagingService
    {
        ...
        protected readonly OneZeroContext _oneZeroContext;
        ...
        public async Task<string> GetTenanCode()
        {
            var code = await RedisHelper.GetAsync(_oneZeroContext.TenanId.ToString());
