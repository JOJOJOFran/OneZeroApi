...
namespace SouthStar.VehSch.Core.Dispatch.Services
{
    public class DispatchQueueService : BaseService
    {
        ...
        public DispatchQueueService(IUnitOfWork unitOfWork, ILogger<DispatchQueueService> logger, IDapperProvider dapper, IMapper mapper) : base(unitOfWork, dapper, mapper)
        {
