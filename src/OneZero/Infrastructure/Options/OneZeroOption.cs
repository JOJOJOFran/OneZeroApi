...
namespace OneZero.Options
{
    ...
    public class OneZeroOption
    {
        ...
        public string DefaulRedisConnectionString { get; set; }

        public ConcurrentDictionary<string, string> DbConnectionString;

        public ConcurrentDictionary<string, string> RedisConnectionString;
