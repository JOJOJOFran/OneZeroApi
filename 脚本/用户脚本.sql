...
VALUES('99BF7D96-BCD5-4083-8197-BFFBEBE4501F','8CAB1C61-A36B-4910-B8EC-7351EA11BA71',0,'admin','管理员','202CB962AC59075B964B07152D234B70','1317932489@qq.com',1,'110',1,dateAdd(yy,100,getdate()),0)
--新增角色
INSERT INTO  dbo.TRole(Id, TenanId, IsDelete, Name, DisplayName, Remark)
VALUES('39BAFB2B-1A48-47D3-A668-2EA2E384CD33','8CAB1C61-A36B-4910-B8EC-7351EA11BA71',0,'admintest','测试管理员','测试用')

INSERT INTO  dbo.TRole(Id, TenanId, IsDelete, Name, DisplayName, Remark)
VALUES('14961444-0DF0-4222-A4EA-0A8CE2AF1019','8CAB1C61-A36B-4910-B8EC-7351EA11BA71',0,'usertest','测试用户','测试用')
--新增UserRole
INSERT INTO dbo.TUserRole(Id, TenanId, IsDelete, UserId, RoleId, RowNo)
VALUES(NEWID(),'8CAB1C61-A36B-4910-B8EC-7351EA11BA71',0,'99BF7D96-BCD5-4083-8197-BFFBEBE4501F','39BAFB2B-1A48-47D3-A668-2EA2E384CD33',0 )

INSERT INTO dbo.TUserRole(Id, TenanId, IsDelete, UserId, RoleId, RowNo)
VALUES(NEWID(),'8CAB1C61-A36B-4910-B8EC-7351EA11BA71',0,'99BF7D96-BCD5-4083-8197-BFFBEBE4501F','14961444-0DF0-4222-A4EA-0A8CE2AF1019',0 )
--新增菜单
...
SELECT [x.UserRoles].[Id], [x.UserRoles].[IsDelete], [x.UserRoles].[RoleId], [x.UserRoles].[RowNo], [x.UserRoles].[TenanId], [x.UserRoles].[UserId]
      ...
      INNER JOIN (
          SELECT TOP(1) [x0].[Id]
          FROM [TUser] AS [x0]
          WHERE ([x0].[IsDelete] = 0) AND ([x0].[Id] ='99BF7D96-BCD5-4083-8197-BFFBEBE4501F')
          ORDER BY [x0].[Id]
